/* CCSDS Reed-Solomon GF(2^8) lookup tables.
 * These match the CCSDS 101.0-B standard RS(255,223) code.
 * Originally from Phil Karn KA9Q's libfec / gr-satellites.
 * May be used under the terms of the GNU Lesser General Public License (LGPL).
 */

/* alpha-to table: ALPHA_TO[i] = alpha^i in GF(2^8)
...
/* index-of table: INDEX_OF[v] = log_alpha(v), or 255 for v=0 */
